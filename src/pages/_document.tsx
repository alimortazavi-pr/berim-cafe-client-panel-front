...
class MyDocument extends Document {
  ...
  render() {
    return (
      <Html lang="fa" dir="rtl" className="bg-[#fafafa]">
        <Head>
          {CssBaseline.flush()}
          <link
          ...
          <meta
            name="description"
            content="شما می‌توانید با بریم کافه خیلی ساده منو آنلاین کافه خود را بسازید و کافه خود را به افراد اطراف خود نمایش دهید"
          ></meta>
